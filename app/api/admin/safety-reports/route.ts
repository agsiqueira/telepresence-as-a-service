...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await listSafetyReportsForAdmin(db, access.user.id, { category: query.get("category"), severity: query.get("severity"), triageStatus: query.get("triageStatus"), cursor: query.get("cursor"), limit: query.get("limit") });
