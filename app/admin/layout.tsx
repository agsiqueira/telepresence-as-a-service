...
const links=[["Participants","/admin/participants"],["Destinations","/admin/destinations"],["Operator applications","/admin/operator-applications"],["Journey Requests","/admin/journey-requests"],["Proposals","/admin/proposals"],["Agreements","/admin/agreements"],["Safety Reports","/admin/safety-reports"]] as const;
