...
const phase3 = process.env.PHASE3_TEST_DATABASE_URL;
const phase4 = process.env.PHASE4_TEST_DATABASE_URL;
...
for (const module of ["agreements", "trip-lifecycle", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) {
...
for (const module of ["agreements", "trip-lifecycle", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) cpSync(`.phase3-test-build/lib/${module}.js`, `${aliasRoot}/${module}.js`);
const test = spawnSync(process.execPath, [".phase3-test-build/scripts/phase5a4-db-integration.js"], { stdio: "inherit", env });
