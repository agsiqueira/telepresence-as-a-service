...
for (const module of ["agreements", "proposals", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) {
...
for (const module of ["agreements", "proposals", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) cpSync(`.phase3-test-build/lib/${module}.js`, `${aliasRoot}/${module}.js`);
