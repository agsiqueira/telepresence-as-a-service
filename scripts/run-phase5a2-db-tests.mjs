...
for (const module of ["agreements", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) {
...
for (const module of ["agreements", "journey-requests", "marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock", "supply-foundation"]) cpSync(`.phase3-test-build/lib/${module}.js`, `${aliasRoot}/${module}.js`);
const test = spawnSync(process.execPath, [".phase3-test-build/scripts/phase5a2-db-integration.js"], { stdio: "inherit", env });
