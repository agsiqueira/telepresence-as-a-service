...
const modules = ["marketplace", "marketplace-vocabulary", "profiles", "safety-restriction-lock"];
...
for (const module of modules) cpSync(`.phase3-test-build/lib/${module}.js`, `${alias}/${module}.js`);
