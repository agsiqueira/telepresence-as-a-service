...
for (const module of ["marketplace", "marketplace-vocabulary", "profiles", "capabilities", "phase3-services", "trip-lifecycle"]) {
...
for (const module of ["db", "current-user", "marketplace", "marketplace-vocabulary", "profiles", "capabilities", "phase3-services", "trip-lifecycle"]) {
